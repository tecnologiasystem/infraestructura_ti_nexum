...
from bll.monitor_rpa_bll import actualizar_ultima_consulta, listar_detalles_rpa, listar_encabezados_rpa, listar_detalles_rpa_paginados, listar_todos_detalles_por_origen, obtener_resumen_vigencia
from dal.monitor_rpa_dal import obtener_datos_encabezado
